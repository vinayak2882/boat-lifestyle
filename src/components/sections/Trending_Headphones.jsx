...
import { fetchData_THEDPHONES } from '../../Redux/OfferZone/action'
// test
...
const Trending_Headphones = () => {
    const products = useSelector((store)=>store.ecommerceData.Trending_Headphones)
   const dispatch =useDispatch()
    useEffect(()=>{
    if(products?.length===0){
        dispatch(fetchData_THEDPHONES())
    }
  ...
  return (
    <Box>
        ...
        <Box>
            <Heading textAlign='center' padding='5' color="white"  as='h2'>Trending Headphones</Heading>
...
export default Trending_Headphones
