...
import { fetchData_TWIRED } from '../../Redux/OfferZone/action'
// test
...
const Trending_Wired = () => {
    const products = useSelector((store)=>store.ecommerceData.Trending_Wired)
   const dispatch =useDispatch()
    useEffect(()=>{
    if(products?.length===0){
        dispatch(fetchData_TWIRED())
    }
  ...
  return (
    <Box>
        ...
        <Box>
            <Heading textAlign='center' padding='5' color="white"  as='h2'>Trending Wired</Heading>
