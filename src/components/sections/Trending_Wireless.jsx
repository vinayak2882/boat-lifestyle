...
import { fetchData_TWIRELESS } from '../../Redux/OfferZone/action'
// test
...
const Trending_Wireless = () => {
    const products = useSelector((store)=>store.ecommerceData.Trending_Wireless)
   const dispatch =useDispatch()
    useEffect(()=>{
    if(products?.length===0){
        dispatch(fetchData_TWIRELESS())
    }
  ...
  return (
    <Box>
        ...
        <Box>
            <Heading textAlign='center' padding='5' color="white"  as='h2'>Trending Wireless</Heading>
...
export default Trending_Wireless
