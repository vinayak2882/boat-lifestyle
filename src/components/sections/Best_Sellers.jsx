...
import { fetchData } from '../../Redux/OfferZone/action'
// test
...
const Best_Sellers = () => {
    const products = useSelector((store)=>store.ecommerceData.Best_Sellers)
  ...
  return (
    <Box>
        ...
        <Box>
            <Heading textAlign='center' padding='5' color="white"  as='h2'>Best Seller</Heading>
